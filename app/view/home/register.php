...
<!-- 
    ...
    <div class="row mt-5">
      ...
      <div class="col-lg-12 mt-5 mt-lg-0">
        ...
        <form action="<?php echo DOMAIN_NAME;?>homecontroller/registerdata" method="post" >
          <div class="form-row">
          <div class="col-md-6 form-group">
            ...
            <div class="col-md-6 form-group">
              <input type="text" name="phone" class="form-control" id="phone" placeholder="Your phone" data-rule="minlen:4" required />
              <div class="validate"></div>
            </div>
            <div class="col-md-6 form-group">
          ...
          <div class="text-center"><button class="btn get-started-btn" type="submit">Register</button></div>
        </form>
        <p><a href="<?php echo DOMAIN_NAME;?>homecontroller/login">Have Account ? Login Now</a></p>
