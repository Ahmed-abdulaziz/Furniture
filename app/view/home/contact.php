...
<!-- 
    ...
    <div class="row mt-5">
      ...
      <div class="col-lg-8 mt-5 mt-lg-0">
        ...
        <form action="<?php echo DOMAIN_NAME;?>contactcontroller/insert" method="post" role="form" class="php-email-form">
          <div class="form-row">
          ...
          <input hidden name="userid" value="<?php echo $_SESSION['id']?>" >
