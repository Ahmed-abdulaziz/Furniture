...
<div class="row">
                            ...
                            <div class="col-lg-12">
                                <form method="post" action="<?php echo DOMAIN_NAME;?>backcontroller/updatetestimonials/<?php echo $data['id']?>" enctype="multipart/form-data">
                                <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="description" value="<?php echo $data['text'];?>"  id="example-date-input" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
