...
<div class="row">
                            ...
                            <div class="col-lg-12">
                                <form method="post" action="<?php echo DOMAIN_NAME;?>backcontroller/updateuser/<?php echo $data['id']?>">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="email" name="email" value="<?php echo $data['email'];?>"  id="example-url-input" required>
                                                </div>
                                            </div> 
                                            <!-- <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="number" name="phone" value="<?php echo $data['phone'];?>" maxlength="11"  id="example-month-input" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-week-input" class="col-sm-2 col-form-label text-right">Address</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="address" value="<?php echo $data['address'];?>" id="example-week-input" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-week-input" class="col-sm-2 col-form-label text-right">Age</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="number" name="age" value="<?php echo $data['age'];?>"  id="example-week-input" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control" name="type" required>
                                                        ...
                                                        <option <?php if($data['type'] == 1){echo "selected";}?> value="1">Admin</option>
                                                        <option <?php if($data['type'] == 0){echo "selected";}?> value="0">User</option>
                                                    </select>
                                                </div>
                                            </div>
