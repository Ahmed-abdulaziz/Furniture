...
<div class="row">
                            ...
                            <div class="col-lg-12">
                                <form method="post" action="<?php echo DOMAIN_NAME;?>backcontroller/inserttestimonials" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="job"  id="example-url-input" required>
                                                </div>
                                            </div> 
                                            <div class="form-group row">
                                                <label for="example-date-input" class="col-sm-2 col-form-label text-right">Description</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="description"  id="example-date-input" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
